...
const Navbar = () => {
  ...
  return (
    {/* <div className="sticky top-0 h-20 w-full max-w-screen-md mx-auto border-b z-50">
    ...
    <div className="sticky top-0 h-24 w-full max-w-screen-md mx-auto border-b z-[1000px]">
